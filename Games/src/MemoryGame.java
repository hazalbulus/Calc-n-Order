...
public class MemoryGame extends JFrame
{
    ...
    public MemoryGame()
    {
        ...
        prize = (int) (Math.random() * 36) + 1;
        bomb1 = (int) (Math.random() * 36) + 1;
        bomb2 = (int) (Math.random() * 36) + 1;
        counter = 0;
        ...
        public void actionPerformed(ActionEvent e) 
        {
            if( e.getSource() == prizeButton || e.getSource() == bomb1Button || e.getSource() == bomb2Button)
            {
                ...
                if(e.getSource() == prizeButton)
                {
                    ...
                    ImageIcon prizeImage = new ImageIcon("realburger.png");
                    ImageIcon bombImage = new ImageIcon("realvegetable.png");
