...
public class HangmanInfo extends JPanel implements HungryManView, ActionListener
{
    ...
    public HangmanInfo(HangHungryMan hangman, AppMain g)
    {
        ...
        knownSoFar = new JLabel("Known so far: " + this.hangman.getKnownSoFar());
    ...
    public void update()
    {
        ...
        knownSoFar.setText("Known so far: " + this.hangman.getKnownSoFar());
        maxToken = new JLabel("Max token that you can earn: 5");
        // if( hangman.lost() == true)
        // {
        //     hangman.newGame();
        // }
        // else if( hangman.won() == true)
        // {
        //     hangman.newGame();
        // }
    }
